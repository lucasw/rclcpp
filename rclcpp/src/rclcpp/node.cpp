  ...
  bool start_parameter_services)
{
  ...
  node_logging_.reset(new rclcpp::node_interfaces::NodeLogging(node_base_.get()));
  node_timers_.reset(new rclcpp::node_interfaces::NodeTimers(node_base_.get()));
  node_topics_.reset(new rclcpp::node_interfaces::NodeTopics(node_base_.get()));
  node_services_.reset(new rclcpp::node_interfaces::NodeServices(node_base_.get()));
  node_clock_.reset(new rclcpp::node_interfaces::NodeClock(
      node_base_,
      node_topics_,
      node_graph_,
      node_services_,
  ...
  node_waitables_.reset(new rclcpp::node_interfaces::NodeWaitables(node_base_.get()));
